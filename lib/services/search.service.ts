  ...
  static async searchBusinesses(params: SearchParams) {
    ...
    if (query && query.trim() !== '') {
      ...
      whereClause.OR = [
        ...
        { whatsapp: { contains: sanitizedQuery, mode: 'insensitive' } },
        { email: { contains: sanitizedQuery, mode: 'insensitive' } },
        { website: { contains: sanitizedQuery, mode: 'insensitive' } },
        ...
        { products: { some: { OR: [{ title: { contains: sanitizedQuery, mode: 'insensitive' } }, { description: { contains: sanitizedQuery, mode: 'insensitive' } }, { whatsappPhone: { contains: sanitizedQuery, mode: 'insensitive' } }] } } },
